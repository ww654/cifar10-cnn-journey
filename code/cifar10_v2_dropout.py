...
log_path = os.path.join(log_dir, f'dropout_run_{timestamp}.txt')
...
class CIFAR10_CNN(nn.Module):
    def __init__(self):
        ...
        self.net = nn.Sequential(
            ...
            nn.BatchNorm2d(32),
            nn.ReLU(),
            nn.MaxPool2d(2, 2),               # 输出：16x16x32
            nn.Dropout(0.25),                 # 随机关闭 25% 的神经元

            # 卷积块 2
            nn.Conv2d(32, 64, 3, padding=1),  # 输出：16x16x64
            nn.BatchNorm2d(64),
            nn.ReLU(),
            nn.Conv2d(64, 64, 3, padding=1),
            nn.BatchNorm2d(64),
            nn.ReLU(),
            nn.MaxPool2d(2, 2),               # 输出：8x8x64
            nn.Dropout(0.25),
